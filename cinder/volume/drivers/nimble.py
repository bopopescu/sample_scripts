...
class NimbleISCSIDriver(san.SanISCSIDriver):
    ...
    def check_if_this_volume_is_backup_clone(self, volume):
        ...
        if vol_info['clone'] and vol_info['base-snap'] and vol_info[
            ...
            if snap_info['description'] and "backup-vol-" in snap_info[\
                ...
                if "backup-vol-" + parent_vol_id in snap_info['description']:
                    LOG.info("nimble backup-snapshot exists name: %s",
                         snap_info['name'])
    ...
    def delete_volume(self, volume):
        ...
        snap_name, vol_name = self.check_if_this_volume_is_backup_clone(volume)
    ...
    def backup_use_temp_snapshot(self):
        LOG.info('nimble backup_use_temp_snapshot')
        return False
...
class NimbleAPIExecutor(object):
    ...
    def snap_vol(self, snapshot):
        ...
        LOG.info("snap_description -%s", snap_description)
