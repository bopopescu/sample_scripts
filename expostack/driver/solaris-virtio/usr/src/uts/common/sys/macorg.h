...
typedef mblk_t *(*mac_tx_ring_fn_t)(void *, mblk_t *, uintptr_t,mac_ring_handle_t *);
...
* client directly.
*/
typedef void (*mac_direct_rx_t)(void *, mac_resource_handle_t,mblk_t *, mac_header_info_t *);
...
typedef int (*mac_resource_modify_t)(void *, void *,mac_resource_t *);
typedef void (*mac_change_upcall_t)(void *, mac_direct_rx_t,void *);
