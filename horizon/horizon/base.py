...
class HorizonComponent(object):
    ...
    def __init__(self):
	#LOG.error("__init__ of HorizonComponent")
    ...
    def __str__(self):
	#LOG.error("__str__ HorizonComponent of HorizonComponent")
        name = getattr(self, 'name', u"Unnamed %s" % self.__class__.__name__)
        return name

    def _get_default_urlpatterns(self):
	#LOG.error("_get_default_urlpatterns of HorizonComponent")
    ...
    def can_access(self, context):
        ...
        """
	#LOG.error("can_access of HorizonComponent")
    ...
    def allowed(self, context):
        ...
        """
	#LOG.error("allowed of HorizonComponent")
        return self._can_access(context['request'])

    def _can_access(self, request):
	#LOG.error("_can_access of HorizonComponent")
...
class Registry(object):
    ...
    def _register(self, cls):
        ...
        """
	#LOG.error("_register of Registry")
    ...
    def _unregister(self, cls):
        ...
        be raised.
        """
	#LOG.error("_unregister of Registry")
	...
	#LOG.error("_registered of Registry")
...
class Panel(HorizonComponent):
    ...
    def get_absolute_url(self):
        ...
        """
	#LOG.error("get_absolute_url of Panel")
	...
	#LOG.error("_decorated_urls of Panel")
...
class PanelGroup(object):
	...
	#LOG.error("__init__ of PanelGroup")
    ...
    def __repr__(self):
	#LOG.error("__repr__ of PanelGroup")
        return "<%s: %s>" % (self.__class__.__name__, self.slug)

    def __str__(self):
	#LOG.error("__str__ of PanelGroup")
        return self.name

    def __iter__(self):
	#LOG.error("__iter__ of PanelGroup")
        panel_instances = []
...
class Dashboard(Registry, HorizonComponent):
    ...
    def __repr__(self):
	#LOG.error("__repr__ of Dashboard")
        return "<Dashboard: %s>" % self.slug

    def __init__(self, *args, **kwargs):
	#LOG.error("__init__ of Dashboard")
    ...
    def get_panel(self, panel):
        ...
        with this dashboard.
        """
	#LOG.error("get_panel of Dashboard")
    ...
    def get_panels(self):
        ...
        """
	#LOG.error("get_panels of Dashboard")
        all_panels = []
    ...
    def get_panel_group(self, slug):
        ...
        """
	#LOG.error("get_panel_group of Dashboard")
        return self._panel_groups.get(slug)

    def get_panel_groups(self):
	
	#LOG.error("get_panel_groups of Dashboard")
	big_data_project_list = ['a523201fb9984f5392cd70f3928e1dfd']

	if project_id in big_data_project_list:
	    ...
	    if self._panel_groups is not None:
                for panel_group in self._panel_groups.values():
		    if str(panel_group.slug) == "data_processing":
			pass
		    else:
                    	for panel in panel_group:
                            registered.pop(panel.__class__)
    ...
    def get_absolute_url(self):
        ...
        """
	#LOG.error("get_absolute_url of Dashboard")
    ...
    @property
    def _decorated_urls(self):
	#LOG.error("_decorated_urls of Dashboard")
        urlpatterns = self._get_default_urlpatterns()
	...
	#LOG.error("_autodiscover of Dashboard")
	...
	#LOG.error("register of Dashbaord")
	...
	#LOG.error("unregister of Dashbaord")
    ...
    def allowed(self, context):
        ...
        when more complex checks are required.
        """
	#LOG.error("allowed of Dashbaord")
...
class LazyURLPattern(SimpleLazyObject):
    def __iter__(self):
	#LOG.error("__iter__ of LazyURLPattern")
	...
	#LOG.error("__reversed__ of LazyURLPattern")
        if self._wrapped is empty:
            self._setup()
        return reversed(self._wrapped)

    def __len__(self):
	#LOG.error("__len__ of LazyURLPattern")
        if self._wrapped is empty:
            self._setup()
        return len(self._wrapped)

    def __getitem__(self, idx):
	#LOG.error("__getitem__ of LazyURLPattern")
        if self._wrapped is empty:
            self._setup()
...
class Site(Registry, HorizonComponent):
    ...
    def __repr__(self):
	#LOG.error("__repr__ of Site")
        return u"<Site: %s>" % self.slug

    @property
    def _conf(self):
	#LOG.error("_conf of Site")
	...
	#LOG.error("get_dashboard of Site")
        return self._registered(dashboard)


    def get_project_id(self,context):
	global project_id
	project_id = context.request.COOKIES['recent_project']	
	#LOG.error("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
    ...
    def get_default_dashboard(self):
        ...
        """
	#LOG.error("get_default_dashboard of Site")
    ...
    def get_user_home(self, user):
        ...
        """
	#LOG.error("get_user_home of Site")
    ...
    def get_absolute_url(self):
        ...
        """
	#LOG.error("get_absolute_url of Site")
    ...
    def _autodiscover(self):
        ...
        """
	#LOG.error("_autodiscover of Site")
        if not getattr(self, '_registerable_class', None):
    ...
    def _load_panel_customization(self):
        ...
        """
	#LOG.error("_load_panel_customization of Site")
	...
	#LOG.error("_process_panel_configuration of Site")
        try:
	...
	#LOG.error("_process_panel_group_configuration of site")
...
class HorizonSite(Site):
    ...
    def __new__(cls, *args, **kwargs):
        #LOG.error("__new__ of HorizonSite")
