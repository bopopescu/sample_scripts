...
class GeneralConfigAction(workflows.Action):
    ...
    availability_zone = forms.ChoiceField(
        ...
        required=False,
        #widget=forms.Select(attrs={"class": "availability_zone_field","disabled":"disabled"})
	widget=forms.HiddenInput(attrs={"class": "availability_zone_field","disabled":"disabled"})
    )
	...
	widget=forms.HiddenInput(attrs={
        #widget=forms.Select(attrs={
            "class": "volumes_availability_zone_field switched","disabled":"disabled",
            "data-switch-on": "storage_loc",
