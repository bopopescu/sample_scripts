...
def checklease(instance):
    for jk in instance.links:
        ...
        controllername2 = str(controllername1[1]).split('/')
        controllername = controllername2[2]
        tenantid1 = str(controllername1[2]).split('/')
        tenantid = tenantid1[2]
        break
    return api.lease.check_instance_lease(controllername, instance.name, tenantid)
...
class InstancesTable(tables.DataTable):
    ...
    ownern = tables.Column(checkowner,verbose_name=_("Owner ID"))
    leasedays = tables.Column(checklease,verbose_name=_("Expire On (UTC)"))
