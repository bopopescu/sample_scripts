...
class SetInstanceDetailsAction(workflows.Action):
    ...
    volume = forms.IntegerField(label=_("Volume Size"),
                                ...
                                #help_text=_("Size of the volume in GB."),widget=forms.TextInput(attrs={'readonly':'readonly'}))
    ...
    def flavors(self, request):
        controllername = api.trove.get_controllername(request)
...
class SetInstanceDetails(workflows.Step):
    ...
    contributes = ("name", "volume", "flavor", "datastore", "lease_days")
    ...
    def handle(self, request, context):
        try:
            ...
            api.trove.instance_create(request,
                                      ...
                                      replica_of=context.get('master'), lease_days=int(context['lease_days']))
            return True
        except Exception:
            exceptions.handle(request)
            return False
