...
def checkowner2(instance):
	...
	LOG.error("Check owner2 checkowner2 exception fired /home/horizon/horizon/openstack_dashboard/dashboards/admin/instances/tables.py")
...
class AdminInstancesTable(tables.DataTable):
    ...
    ownern = tables.Column(checkowner2,verbose_name=_("Owner ID"),classes=('nowrap-col',))
