...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        try:
            #instances, self._more = api.nova.server_list( Following change is made in reference with GIT-1298, function call changed.
	    instances, self._more = api.nova.server_user_list(
                self.request,
