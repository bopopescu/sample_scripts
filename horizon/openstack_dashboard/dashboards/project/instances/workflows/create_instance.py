...
class SetInstanceDetailsAction(workflows.Action):
    ...
    isalphavalidator = RegexValidator(r'^[0-9a-zA-Z-]*$',
                             message='Name must be alphanumeric including Hypen',
                             code='Invalid name')
    ...
    lease_days = forms.IntegerField(label=_("Lease Days"),
                               ...
                               max_value=60,
                               initial=1,
                               help_text=_("Number of Lease Days."))
    ...
    def __init__(self, request, context, *args, **kwargs):
        ...
        if api.lease.lease_project_verify(request.user.tenant_id, controllername) == False:
...
class SetInstanceDetails(workflows.Step):
    ...
    contributes = ("source_type", "source_id",
                   "availability_zone", "name", "count", "lease_days", "flavor",
...
class LaunchInstance(workflows.Workflow):
    ...
    def handle(self, request, context):
        ...
        security_group_ids_default = []
        dev_mapping_1_default = ""
        dev_mapping_2_default = ""
        admin_pass_default = ""
        disk_config_default = "AUTO"
        ...
        try:
            api.nova.server_create(request,
                                   ...
                                   custom_script,
                                   security_group_ids_default,
                                   block_device_mapping=dev_mapping_1_default,
                                   block_device_mapping_v2=dev_mapping_2_default,
                                   nics=nics,
                                   availability_zone=avail_zone,
                                   instance_count=int(context['count']),
                                   admin_pass=admin_pass_default,
                                   disk_config=disk_config_default,
                                   config_drive=config_drive_default,
                                   lease_days=int(context['lease_days']))
