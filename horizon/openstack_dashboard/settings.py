...
if LOGIN_URL is None:
    from openstack_dashboard.loginurl import get_login_url
    logging.warning("Jordan settings URL : " +  str(get_login_url()))
    #LOGIN_URL = WEBROOT + str(api.loginurl.get_login_url)
    LOGIN_URL = WEBROOT + 'auth/' + str(get_login_url()) + '/'
