...
def notify(receiver, vmname, flavor, whattodo,ipaddressa):
    ...
    if whattodo == "createrequestsuccess":
       ...
       html1 = "<html><head></head><body><b>VM Name  : </b>" + vmname + domainnam + "<br><b>Flavor : </b>" + flavor + "<br><b>IP Address : </b>" + ipaddressa + "<br><br><b> Thanks and Regards</b><br>Expostack Administrator"

    if whattodo == "deleterequestsuccess":
       msg['Subject'] = "Virtual Machine " + vmname + domainnam + " delete completed successfully"
       html1 = "<html><head></head><body><b>VM Name  : </b>" + vmname + domainnam + " deleted successfully.<br><br><b> Thanks and Regards</b><br>Expostack Administrator"
		   ...
		   if jordanipaddress  in ipcalc.Network('10.26.32.0/20'):
                        ...
                        try:
                             ...
                             data='SuccessCreate'
                                ...
                                LOG.info(_LI("\n Instance DNS request failed .. trying again with secondary DNS \n"))
                                data='SuccessCreate'
                                r = requests.get(dnsapiurl)
                   else:
                   ...
                   if data == "SuccessCreate":
                      ...
                      LOG.info(_LI("Instance DNS Entry successfully created."),
                             instance=instance)
                      raise loopingcall.LoopingCallDone()
                   else:
...
#                     db.commit()
#                     db.close()
#                     raise exception.DNSUnreachable(hostname=instance.hostname)
#                  s.close()
        ...
        for rows in resultnew:
           ...
           #   data = s.recv(1024)
               ...
               if data == "SuccessDelete" :
                  ...
                  LOG.info(_LI("Instance DNS Entry successfully deleted."),
                     instance=instance)
                  return True
               else:
                  LOG.info(_LI("Failed to delete DNS Entry for instance."),
                     instance=instance)
                  return False
